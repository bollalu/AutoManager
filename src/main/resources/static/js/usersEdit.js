...
function modalSpedizione(){
 if ((document.getElementById('username').value.length > 2) && (document.getElementById('email').value.length > 7)){
	 waitingDialog.show('Spedizione Password a ' + document.getElementById('email').value + ' in corso...');
 }
}
